...
public class TinyDB {
    ...
    public ArrayList<DomainFashion> getListObject(String key){
    	Gson gson = new Gson();

  	ArrayList<String> objStrings = getListString(key);
   	ArrayList<DomainFashion> objects =  new ArrayList<DomainFashion>();

    	for(String jObjString : objStrings){
   		DomainFashion value  = gson.fromJson(jObjString,  DomainFashion.class);
   		objects.add(value);
  	}
  	return objects;
   }
...
//    }
//    
  public void putListObject(String key, ArrayList<DomainFashion> objArray){
  	checkForNullKey(key);
  	Gson gson = new Gson();
